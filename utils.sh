...
APP_NAME="${APP_NAME:-Aimux}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-aimux-ai/aimux}"
BINARY_NAME="${BINARY_NAME:-aimux}"
GH_REPO_PATH="${GH_REPO_PATH:-aimux-ai/aimux}"
ORG_NAME="${ORG_NAME:-Aimux}"
